...
from priv_bayes.DataSynthesizer.datatypes.AbstractAttribute import AbstractAttribute
from priv_bayes.DataSynthesizer.datatypes.DateTimeAttribute import is_datetime, DateTimeAttribute
from priv_bayes.DataSynthesizer.datatypes.FloatAttribute import FloatAttribute
from priv_bayes.DataSynthesizer.datatypes.IntegerAttribute import IntegerAttribute
from priv_bayes.DataSynthesizer.datatypes.SocialSecurityNumberAttribute import is_ssn, SocialSecurityNumberAttribute
from priv_bayes.DataSynthesizer.datatypes.StringAttribute import StringAttribute
...
class DataDescriber:
    ...
    def describe_dataset_in_correlated_attribute_mode(self,
        ...
        seed : int or float
            ...
            :param k:
            :param epsilon:
            :param attribute_to_datatype:
            :param attribute_to_is_categorical:
            :param attribute_to_is_candidate_key:
            :param seed:
            :param numerical_attribute_ranges:
            :param categorical_attribute_domain_file:
            :param weights:
        """
